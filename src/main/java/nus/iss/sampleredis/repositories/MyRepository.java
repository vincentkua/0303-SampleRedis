...
public class MyRepository {
    ...
    public void deletefruitbyname(String fruitname) {
        template.opsForList().remove("fruit", 1, fruitname);
    }

    public void deletefruit(Integer index) {
        // use set to replace with unique words based on index, then remove it
